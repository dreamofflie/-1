...
def count_letters(text):
    ...
    for char in text:
        ...
        if char_lower.isalpha():  # Проверяем, является ли символ буквой
...
def calculate_frequency(letter_count):
    ...
    frequency = {letter: count / total_letters for letter, count in letter_count.items()}  # Вычисляем частоту
    return frequency
